...
public class SearchFilter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if((cafeState & 0b100000000000000) == 0b100000000000000) cb1.setChecked(true);
        if((cafeState & 0b010000000000000) == 0b010000000000000) cb2.setChecked(true);
        if((cafeState & 0b001000000000000) == 0b001000000000000) cb3.setChecked(true);
        if((cafeState & 0b000100000000000) == 0b000100000000000) cb4.setChecked(true);
        if((cafeState & 0b000010000000000) == 0b000010000000000) cb5.setChecked(true);
        if((cafeState & 0b000001000000000) == 0b000001000000000) cb6.setChecked(true);
        if((cafeState & 0b000000100000000) == 0b000000100000000) cb7.setChecked(true);
        if((cafeState & 0b000000010000000) == 0b000000010000000) cb8.setChecked(true);
        if((cafeState & 0b000000001000000) == 0b000000001000000) cb9.setChecked(true);
        if((cafeState & 0b000000000100000) == 0b000000000100000) cb10.setChecked(true);
        if((cafeState & 0b000000000010000) == 0b000000000010000) cb11.setChecked(true);
        if((cafeState & 0b000000000001000) == 0b000000000001000) cb12.setChecked(true);
        if((cafeState & 0b000000000000100) == 0b000000000000100) cb13.setChecked(true);
        if((cafeState & 0b000000000000010) == 0b000000000000010) cb14.setChecked(true);
